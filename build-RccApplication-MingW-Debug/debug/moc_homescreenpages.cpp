...
#include "../../RccApplication/homescreenpages.h"
...
static const uint qt_meta_data_SchoolInfo[] = {
...
static const char qt_meta_stringdata_SchoolInfo[] = {
    "SchoolInfo\0"
};

void SchoolInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData SchoolInfo::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SchoolInfo::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SchoolInfo,
      qt_meta_data_SchoolInfo, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SchoolInfo::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION

const QMetaObject *SchoolInfo::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->metaObject : &staticMetaObject;
}

void *SchoolInfo::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SchoolInfo))
        return static_cast<void*>(const_cast< SchoolInfo*>(this));
    return QWidget::qt_metacast(_clname);
}

int SchoolInfo::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QWidget::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
