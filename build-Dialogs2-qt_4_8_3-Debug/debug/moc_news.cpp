...
static const char qt_meta_stringdata_news[] = {
    "news\0"
};
...
const QMetaObjectExtraData news::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject news::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_news,
      qt_meta_data_news, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &news::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_news))
